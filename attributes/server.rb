...
if node['pdns']['server_config_version'] == 2
  ...
  default['pdns']['server']['max_cache_entries'] = 1_000_000
  default['pdns']['server']['max_ent_entries'] = 100_000
  ...
  default['pdns']['server']['tcp_control_port'] = 53_000
...
default['pdns']['server']['default_ttl'] = 3_600
...
default['pdns']['server']['max_queue_length'] = 5_000
...
default['pdns']['server']['queue_limit'] = 1_500
...
default['pdns']['server']['soa_expire_default'] = 604_800
default['pdns']['server']['soa_minimum_ttl'] = 3_600
default['pdns']['server']['soa_refresh_default'] = 10_800
default['pdns']['server']['soa_retry_default'] = 3_600
